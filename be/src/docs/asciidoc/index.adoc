...
=== 회원 장르 정보 조회
==== 성공
operation::memberGenreRead_success['http-request,http-response']
...
operation::fetchMovieGenresWithMovieDetail_success[http-response']
...
=== 메인페이지
==== 성공
operation::fetchBookListByBestseller_success[snippets='http-request,http-response']

=== 상세페이지
==== 성공
operation::getBookDetail_success[snippets='http-request,http-response']
...
==== 일대일 채팅 생성 실패
operation::createOneononeChatroom_failed_duplicated[snippets='http-response']
...
=== 장르
=== 성공
operation::genreRead_success[snippets='http-response']
